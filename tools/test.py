...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, epoch_id, dist_test=False,tb_log=None,model_type = None):
    # load checkpoint
    ...
    eval_utils.eval_one_epoch(
        ...
        result_dir=eval_output_dir, save_to_file=args.save_to_file,tb_log=tb_log,model_type = model_type
    )
...
def repeat_eval_ckpt(model, test_loader, args, eval_output_dir, logger, ckpt_dir, dist_test=False,tb_log=None,model_type = None):
    ...
    while True:
        ...
        tb_dict = eval_utils.eval_one_epoch(
            ...
            result_dir=cur_result_dir, save_to_file=args.save_to_file,tb_log=tb_log,model_type = model_type
        )
